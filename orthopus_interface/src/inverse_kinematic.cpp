...
void InverseKinematic::Init(int sampling_freq, ros::Publisher& debug_pose_current, ros::Publisher& debug_pose_desired,
                                               ...
                                               double (&cartesian_velocity_desired)[6])
{
  ...
  //     {
  //       ROS_ERROR_STREAM("==============> Euler jump detected on axis " << i << " !!!! delta=" << x_cmd_prev(i, 0) -
  //       x_cmd_prev_saved(i, 0) <<"");
  ...
  if (!kinematic_state->getJacobian(joint_model_group, kinematic_state->getLinkModel("tool_link"),
  ...
  double lbA[] = { /* Joints min hard limits constraints */
                   (joints_limits_min[0] - q_cmd_prev.position[0]), (joints_limits_min[1] - q_cmd_prev.position[1]),
                   (joints_limits_min[2] - q_cmd_prev.position[2]), (joints_limits_min[3] - q_cmd_prev.position[3]),
                   (joints_limits_min[4] - q_cmd_prev.position[4]), (joints_limits_min[5] - q_cmd_prev.position[5]),
                   (x_min_limit(0, 0) - x_cmd_prev(0, 0)),          (x_min_limit(1, 0) - x_cmd_prev(1, 0)),
                   (x_min_limit(2, 0) - x_cmd_prev(2, 0)),          (x_min_limit(3, 0) - x_cmd_prev(3, 0)),
                   (x_min_limit(4, 0) - x_cmd_prev(4, 0)),          (x_min_limit(5, 0) - x_cmd_prev(5, 0))

  };
  double ubA[] = { /* Joints min hard limits constraints */
                   (joints_limits_max[0] - q_cmd_prev.position[0]), (joints_limits_max[1] - q_cmd_prev.position[1]),
                   (joints_limits_max[2] - q_cmd_prev.position[2]), (joints_limits_max[3] - q_cmd_prev.position[3]),
                   (joints_limits_max[4] - q_cmd_prev.position[4]), (joints_limits_max[5] - q_cmd_prev.position[5]),
                   (x_max_limit(0, 0) - x_cmd_prev(0, 0)),          (x_max_limit(1, 0) - x_cmd_prev(1, 0)),
                   (x_max_limit(2, 0) - x_cmd_prev(2, 0)),          (x_max_limit(3, 0) - x_cmd_prev(3, 0)),
                   (x_max_limit(4, 0) - x_cmd_prev(4, 0)),          (x_max_limit(5, 0) - x_cmd_prev(5, 0))
